...
export const mockOption: AjaxResponse<Options> = {
    ...
    data: {
        ...
        label_paginate_search_text: 'Search by',
        label_paginate_search_text_placeholder: 'ticker, name or pool_id',
        label_paginate_search_metadata: 'Has metadata',
        ...
        "metadata_extended": {
            "info": {
                ...
                "social": {
                    ...
                    "linkedin_handle": "Upstream_ada"
                },
                "verification_cexplorer": null
            },
            "itn": {
                "owner": 'xxxx',
                "witness": 'xxxx',
